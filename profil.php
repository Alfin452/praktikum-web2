<div class="row">
    <div class="col-md-12">
        <div class="text-center">
            <img src="img/fix1.jpg" alt="Muhammad Alfin Nur Huda" width="160" height="160" class="rounded-circle">
            <table class="table mt-4" style="width:100%; margin:0 auto;">
                <tbody>
                    <tr>
                        <td align="right" width="50%"><strong>NIK / NIDN :</strong></td>
                        <td align="left" width="50%">2210010359 / 2210010359</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td align="left" width="50%">Muhammad Alfin</td>
                    </tr>
                    <tr>
                        <td align="right" width="50%"><strong>Tempat, Tanggal Lahir :</strong></td>
                        <td align="left" width="50%">Banjarmasin, Februari 2005</td>
                    </tr>
                    <tr>
                        <td align="right" width="50%"><strong>Telepon :</strong></td>
                        <td align="left" width="50%">085780979366</td>
                    </tr>
                    <tr>
                        <td align="right" width="50%"><strong>email :</strong></td>
                        <td align="left" width="50%">muhammadalfinnurhuda@gmail.com</td>
                    </tr>
                    <tr>
                        <td align="right" width="50%"><strong>Media Sosial :</strong></td>
                        <td align="left" width="50%">
                            <a href="https://web.facebook.com/profile.php?id=100034609119034" target="_blank" style="text-decoration:none;">
                                <img src="img/facebook.svg" width="30" alt="facebook">
                            </a>
                            <a href="http://instagram.com/alfin_nh_" target="_blank" style="text-decoration:none;">
